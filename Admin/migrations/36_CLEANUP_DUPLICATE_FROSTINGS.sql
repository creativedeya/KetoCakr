-- ============================================================
-- File: 36_CLEANUP_DUPLICATE_FROSTINGS.sql
-- Project: KetoCakR | Date: 2026-04-07
-- Description: Remove duplicate base_recipes for recipe_role_id = 2
...
-- Step 4: Verify — should show 13 recipes, all count = 1
