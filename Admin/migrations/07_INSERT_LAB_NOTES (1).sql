-- ==========================================
-- INSERT LAB NOTES - ALL 95 Notes
-- Date: 2026-04-02
-- Purpose: Insert all lab notes from AI corrections
-- ==========================================
...
-- ==========================================
-- 1. БАЗОВА РЕЦЕПТА ЗА ВЪЗДУШНИ КЕТО БЛАТОВЕ (3 notes)
-- ==========================================
...
1
FROM base_recipes WHERE name = 'Базова рецепта за въздушни кето блатове' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Кето кексово тесто' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Кокосови блатове' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Ванилов блат' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Морковен блат' AND recipe_role_id = 1;
...
-- ==========================================
-- 7. МАСЛЕН МОРКОВЕН БЛАТ (2 notes)
-- ==========================================
INSERT INTO lab_notes (recipe_id, category, title, title_bg, content, content_bg, display_order)
SELECT id, 'technique',
...
1
FROM base_recipes WHERE name = 'Маслен морковен блат' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Матча пандишпан' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Шоколадов пандишпан' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Червено кадифе' AND recipe_role_id = 1;
...
-- ==========================================
-- 11. МНОГО ШОКОЛАДОВ БЛАТ (4 notes)
-- ==========================================
INSERT INTO lab_notes (recipe_id, category, title, title_bg, content, content_bg, display_order)
SELECT id, 'technique',
...
1
FROM base_recipes WHERE name = 'Много шоколадов блат' AND recipe_role_id = 1;
...
-- ==========================================
-- 12. ФРЕНСКА ЦЕЛУВКА (DACQUOISE) (3 notes)
-- ==========================================
INSERT INTO lab_notes (recipe_id, category, title, title_bg, content, content_bg, display_order)
SELECT id, 'technique',
...
1
FROM base_recipes WHERE name = 'Френска целувка (Dacquoise)' AND recipe_role_id = 1;
...
-- ==========================================
-- 13. БАДЕМОВИ БЛАТОВЕ (SWEDISH STYLE) (3 notes)
-- ==========================================
INSERT INTO lab_notes (recipe_id, category, title, title_bg, content, content_bg, display_order)
SELECT id, 'texture',
...
1
FROM base_recipes WHERE name = 'Бадемови блатове (Swedish Style)' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Гараш блатове' AND recipe_role_id = 1;
...
-- ==========================================
-- 15. БРАУНИ БЛАТ (FLOURLESS) (4 notes)
-- ==========================================
INSERT INTO lab_notes (recipe_id, category, title, title_bg, content, content_bg, display_order)
SELECT id, 'texture',
...
1
FROM base_recipes WHERE name = 'Брауни блат (Flourless)' AND recipe_role_id = 1;
...
1
FROM base_recipes WHERE name = 'Сахер блат' AND recipe_role_id = 1;
...
-- ==========================================
-- SUMMARY: 51 lab notes for 16 recipes
-- ==========================================

-- Verify insert
SELECT 'Lab notes inserted' as status, COUNT(*) as total_count FROM lab_notes;