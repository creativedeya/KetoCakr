-- Migration: Fix calculate_recipe_cost for anonymous users (no user_id)
-- Date: 2025-05-01
-- Description: Simplified RPC function that uses default prices with proper unit conversion
...
BEGIN
  ...
  LOOP
    ...
    IF v_price IS NOT NULL AND v_price > 0 THEN
      ...
      ELSIF v_price_unit IN ('бр', 'piece', 'pc', 'шт') AND v_ingredient.unit IN ('бр', 'piece', 'pc', 'шт') THEN
