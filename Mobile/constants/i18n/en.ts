...
export const en: TranslationKeys = {
  ...
  panConverter: {
    ...
    enterSize: 'Enter dimensions',
    liters: 'L',
    changePan: 'Change pan',
    changeServings: 'Change servings',
    recipeSays: 'Recipe says',
    iHave: 'I have',
    coefficient: 'Multiplier',
    multiplyBy: 'Multiply all ingredients by',
    recommendedPan: 'Recommended pan',
    recipeServings: 'Recipe is for',
    desiredServings: 'I want to make',
    units: 'Unit',
  },
